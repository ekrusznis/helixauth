                            ...
                            <div className="col-lg-6">
                                <div className="sc-feature-item sc-pr-90">
                                    <div className="sc-heading-area sc-mb-30">
                                        <h2 className="heading-title">Unleash the Power of Blockchain in Your Business</h2>
                                    </div>
                                    <div className="feature-content-box">
                                        ...
                                        <div className="sc-feature-text">
                                            <h4 className="feature-title"><Link to="#">Immutable Security</Link></h4>
                                            <div className="description sc-mb-25">Enhance your business security with blockchain's tamper-proof ledger, ensuring data integrity and trust</div>
                                        </div>
                                    </div>
                                    <div className="feature-content-box">
                                        <div className="feature-icon">
                                        ...
                                        <div className="sc-feature-text">
                                            <h4 className="feature-title"><Link to="#">Transparent Operations</Link></h4>
                                            <div className="description sc-mb-25">Boost operational transparency and accountability with blockchain's clear, immutable record-keeping</div>
                                        </div>
                                    </div>
                                    <div className="feature-content-box">
                                        <div className="feature-icon">
